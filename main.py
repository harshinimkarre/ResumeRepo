...
def process_context_for_richtext(context_data: dict) -> dict:
    ...
    #     if key in ("SUMMARY","KEY_RESPONSIBILITES_FS", "KEY_RESPONSIBILITES_DN", "KEY_RESPONSIBILITES_RX", "KEY_RESPONSIBILITES_LW") and isinstance(value, list):
    #         processed_list = []
    #         for item in value:
        ...
        if key in ("SUMMARY","KEY_RESPONSIBILITES_FS", "KEY_RESPONSIBILITES_DN", "KEY_RESPONSIBILITES_RX", "KEY_RESPONSIBILITES_LW") and isinstance(value, list):
            ...
            for item in value:
                if isinstance(item, str):
                    ...
                    processed_list.append(item) # for nulls, etc.
            processed_context[key] = processed_list
        elif key in  ("PD_FS", "PD_DN", "PD_RX", "PD_LW") and isinstance(value, str):
...
def generate_docx(payload: GenerateRequest, template_path: str):
    ...
    try:
        ...
        doc.save("Harshini_Merugumala_Resume.docx")
        ...
        return GenerateResponse(
            filename="Harshini_Merugumala_Resume.docx",
            docx_b64=docx_b64
        )
